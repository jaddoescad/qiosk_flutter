              ...
              children: <Widget>[
                  ...
                  Expanded(
                    ...
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: <Widget>[
                        Text(item.title, textAlign: TextAlign.left, overflow: TextOverflow.ellipsis, maxLines: 1, style: TextStyle(fontSize: 15, color: kMainColor, fontWeight: FontWeight.bold)),
                        item.selectionTitles.length > 0 ? Text(" ") : Container(),
